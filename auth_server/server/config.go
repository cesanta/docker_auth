...
type Config struct {
	...
	BitbucketAuth *authn.BitbucketAuthConfig  `yaml:"bitbucket_auth,omitempty"`
...
func validate(c *Config) error {
	...
	if c.Users == nil && c.GoogleAuth == nil && c.LDAPAuth == nil && c.MongoAuth == nil && c.BitbucketAuth == nil {
